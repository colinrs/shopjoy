<template>
  <div class="variants-section" v-loading="loading">
    <div class="section-header">
      <h3 class="section-title">{{ $t('products.productVariants') }}</h3>
      <el-button type="primary" size="small" @click="handleShowAddVariantDialog">
    ...
    <el-empty v-if="variants.length === 0 && !loading" :description="$t('products.noVariants')">
      <el-button type="primary" @click="handleShowAddVariantDialog">{{ $t('products.addVariant') }}</el-button>
    </el-empty>
  </div>
</template>
