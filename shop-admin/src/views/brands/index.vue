      ...
      <div class="filter-bar">
        <div class="filter-left">
          ...
          >
            ...
            />
            <el-option
              :label="$t('brands.enabled')"
              :value="1"
            />
            <el-option
              :label="$t('brands.disabled')"
              :value="0"
            />
          </el-select>
          <el-button
