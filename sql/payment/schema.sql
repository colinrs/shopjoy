...
CREATE TABLE IF NOT EXISTS `payments` (
    ...
    `paid_at` BIGINT DEFAULT NULL COMMENT '支付时间(Unix时间戳(秒))',
    `expire_at` BIGINT NOT NULL DEFAULT 0 COMMENT '过期时间(Unix时间戳(秒))',
...
CREATE TABLE IF NOT EXISTS `order_payments` (
    ...
    `paid_at` BIGINT DEFAULT NULL COMMENT 'Payment success time (Unix timestamp (seconds))',
    `failed_at` BIGINT DEFAULT NULL COMMENT 'Payment failure time (Unix timestamp (seconds))',
    `failed_reason` VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'Failure reason',
    `created_at` BIGINT NOT NULL COMMENT 'Created at (Unix timestamp (seconds))',
    `updated_at` BIGINT NOT NULL COMMENT 'Updated at (Unix timestamp (seconds))',
    `deleted_at` BIGINT DEFAULT NULL COMMENT 'Deleted at (Unix timestamp (seconds), soft delete)',
    PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `payment_refunds` (
    ...
    `created_at` BIGINT NOT NULL COMMENT 'Created at (Unix timestamp (seconds))',
    `updated_at` BIGINT NOT NULL COMMENT 'Updated at (Unix timestamp (seconds))',
    `refunded_at` BIGINT DEFAULT NULL COMMENT 'Refund completed time (Unix timestamp (seconds))',
    `deleted_at` BIGINT DEFAULT NULL COMMENT 'Deleted at for soft delete (Unix timestamp (seconds))',
...
CREATE TABLE IF NOT EXISTS `webhook_events` (
    ...
    `created_at` BIGINT NOT NULL COMMENT 'Created at (Unix timestamp (seconds))',
    `updated_at` BIGINT NOT NULL COMMENT 'Updated at (Unix timestamp (seconds))',
    `processed_at` BIGINT DEFAULT NULL COMMENT 'Processed time (Unix timestamp (seconds))',
    PRIMARY KEY (`id`),
