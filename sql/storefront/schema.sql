...
-- SEO配置数据 (Demo Shop)
INSERT IGNORE INTO `seo_configs` (`tenant_id`, `page_type`, `page_id`, `title`, `description`, `keywords`, `created_at`, `updated_at`) VALUES
(1, 'global', NULL, 'Demo Shop - 高品质运动装备', 'Demo Shop 提供Nike、Adidas等品牌运动鞋服，正品保障，全国包邮', '运动鞋,跑步鞋,Nike,Adidas', NOW(), NOW()),
(1, 'home', NULL, 'Demo Shop - 首页', 'Demo Shop 官方首页', '首页', NOW(), NOW()),
(1, 'product', NULL, '{{product_name}} - Demo Shop', '{{product_description}}', '', NOW(), NOW()),
(1, 'category', NULL, '{{category_name}} - Demo Shop', 'Browse our {{category_name}} collection', '', NOW(), NOW());
