...
CREATE TABLE IF NOT EXISTS `shops` (
    ...
    `deleted_at` BIGINT DEFAULT NULL COMMENT 'Soft delete timestamp (Unix seconds)',
...
CREATE TABLE IF NOT EXISTS `pages` (
    ...
    `published_at` BIGINT DEFAULT NULL COMMENT 'Published timestamp (Unix seconds)',
...
CREATE TABLE IF NOT EXISTS `decorations` (
    ...
    `deleted_at` BIGINT DEFAULT NULL COMMENT 'Soft delete timestamp (Unix seconds)',
    `created_at` BIGINT NOT NULL COMMENT 'Created timestamp (Unix seconds)',
    `updated_at` BIGINT NOT NULL COMMENT 'Updated timestamp (Unix seconds)',
    PRIMARY KEY (`id`),
