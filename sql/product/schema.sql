...
CREATE TABLE IF NOT EXISTS `products` (
    ...
    `price` DECIMAL(19,4) NOT NULL DEFAULT 0 COMMENT '售价',
    `cost_price` DECIMAL(19,4) NOT NULL DEFAULT 0 COMMENT '成本价',
...
CREATE TABLE IF NOT EXISTS `skus` (
    ...
    `price_amount` DECIMAL(19,4) NOT NULL DEFAULT 0 COMMENT '价格',
