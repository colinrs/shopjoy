...
(1, 'QUALITY', '商品质量问题', 10, 1, UNIX_TIMESTAMP()),
(2, 'WRONG_ITEM', '商品与描述不符', 20, 1, UNIX_TIMESTAMP()),
(3, 'NOT_RECEIVED', '未收到商品', 30, 1, UNIX_TIMESTAMP()),
(4, 'CHANGED_MIND', '买家改变主意', 40, 1, UNIX_TIMESTAMP()),
(5, 'DUPLICATE_ORDER', '重复下单', 50, 1, UNIX_TIMESTAMP()),
(6, 'OTHER', '其他原因', 100, 1, UNIX_TIMESTAMP());
