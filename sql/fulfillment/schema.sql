...
CREATE TABLE IF NOT EXISTS `shipments` (
    ...
    `shipped_at` BIGINT DEFAULT NULL COMMENT '发货时间(Unix时间戳(秒))',
    `delivered_at` BIGINT DEFAULT NULL COMMENT '送达时间(Unix时间戳(秒))',
    ...
    `deleted_at` BIGINT NULL DEFAULT NULL COMMENT '删除时间(Unix时间戳(秒))',
    PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `refunds` (
    ...
    `approved_at` BIGINT DEFAULT NULL COMMENT '批准时间(Unix时间戳(秒))',
...
CREATE TABLE IF NOT EXISTS `shipping_templates` (
    ...
    `deleted_at` BIGINT NULL DEFAULT NULL COMMENT 'Deleted at (Unix timestamp (seconds))',
