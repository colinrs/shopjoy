...
type OrderFulfillmentDetailResp struct {
	...
	Currency          string                      `json:"currency"`
	UserID            int64                       `json:"user_id,string"`
	UserName          string                      `json:"user_name,optional"`  // mirrors receiver_name
	UserPhone         string                      `json:"user_phone,optional"` // mirrors receiver_phone
	...
	Remark            string                      `json:"remark,optional"` // 用户备注
